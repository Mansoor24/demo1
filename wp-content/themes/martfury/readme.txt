...
- Fix: Missing a close icon for the message box of the wishlist
_ Fix: Some bugs related to RTL

Version 3.0.7

- Fix: Error get_wishlist_fragments
...
- Update: Compatible with WooCommerce 7.8.2
- Update: WPBakery Page Builder 6.13.0
- Update: Revolution Slider 6.6.14
- Fix: Wishlist notification doesn't work
- Fix: Filter button type doesn't work.

Version 3.0.4

- Fix: Add to Cart AJAX doesn't work on the single product

Version 3.0.3

- Update: Compatible with WooCommerce 7.8.0
- New: Add an option to enable one column for Product Carousel
